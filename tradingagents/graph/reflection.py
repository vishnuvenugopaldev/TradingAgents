...
class Reflector:
    ...
    def _get_log_reflection_prompt(self) -> str:
        ...
        return (
            ...
            "Cover in order:\n"
            "1. Was the directional call correct? (cite the excess-return-vs-SPY figure)\n"
            "2. Which part of the investment thesis held or failed?\n"
            "3. One concrete lesson to apply to the next similar analysis.\n\n"
            "Note: 'excess return vs SPY' is raw return minus SPY's return over the same window. "
            "It is not risk-adjusted alpha — do not call it that.\n\n"
    ...
    def reflect_on_final_decision(
        ...
        ``excess_return`` is ``raw_return - SPY_return`` over the holding
        window — excess return, not alpha (no beta adjustment, no factor
        model). The prompt language reflects that distinction.
        """
        messages = [
